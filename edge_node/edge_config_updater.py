...
# Note: $geoip2_country_code requires ngx_http_geoip2_module
# If not available, it will be empty and we'll use IP-based lookup
...
# GeoIP2 configuration (if module is available)
